        ...
        <main>
            ...
            <div className='row justify-content-center mb-1'>
                <div className='col-12 col-md-6'>
                    <a href="https://erockenmeyer.github.io/Portfolio/" target='_blank'>
                ...
                <div className='col-12 col-md-6'>
                    <a href="https://erockenmeyer.github.io/project-1-the-spell-book/" target="_blank">
                ...
                <div className='col-12 col-md-6'>
                    <a href="https://warm-castle-28524.herokuapp.com/" target="_blank">
